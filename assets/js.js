...
(function (window, document) {
    ...
    var _list = function (where) {
        var _w = $(where);
        return Array.prototype.slice.call(_w);
    };
    var _one = function (where) {
        var _o = _list(where);
        return _o[0];
    };
    ...
    NodeList.prototype.hide = function (event, fn) {
        []["forEach"].call(this, function (el) {
    ...
    NodeList.prototype.show = function (event, fn) {
        []["forEach"].call(this, function (el) {
    ...
    var lazy_imgs = _list(".lazy_img");
    setTimeout(function () {
        for (var i in lazy_imgs) {
            var _img = lazy_imgs[i];
            var _src = _img.getAttribute("_src");
            _img.src = _src;
